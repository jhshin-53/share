...
TEXT_MIN_WIDTH = 400      # min reduced px width of detected text contour
...
def remap_image(name, img, small, page_dims, params):
    ...
    #     threshfile = name + '_ckbs_line3.png'
    # else:
    #     threshfile = name + '_ckbs_full.png'
...
def img_process(num, start, total_len, imgfile):
    ...
    if OPTI_SANS_3LINE == True :
        ...
        spans_opti.append(spans[len(spans) -3])
        spans = spans_opti
